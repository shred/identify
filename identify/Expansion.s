...
manuf_tab       tabinit
		...
		board     042,"SE 2000"                 ,MSG_EXP_RAM    ;boards
		endmf   00221
		...
		board     069,"A2232 (prototype)"       ,MSG_EXP_MULTIIO ;hat's der Bach jetzt auch in Klammern?
		...
		board     103,"A2386 SX"                ,MSG_EXP_BRIDGE
		board     106,"CD³²"                    ,MSG_EXP_SCSIHD ;boards
		...
		board     004,"8-Up! (PIC B)"           ,MSG_EXP_RAM    ;Hat der Bach jetzt nen Pic B?
		board     018,"Modem 19"                ,MSG_EXP_MODEM  ;boards
		...
		board     001,"Allegra"                 ,MSG_EXP_RAM    ;boards
		endmf   01012
		...
		board     020,"1600-GX"                 ,MSG_EXP_GFX    ;boards
		endmf   01053
		...
		board     001,"BattDisk"                ,MSG_EXP_MISC   ;boards ;RAM-Disk
		...
		board     002,"?"                       ,MSG_EXP_RAM    ;boards
		board     068,"Rambrandt"               ,MSG_EXP_GFX    ;boards
		board     105,"A2000 68040"             ,MSG_EXP_TURBOANDRAM
		board     120,"ProRAM 3000"             ,MSG_EXP_RAM    ;boards
		board     150,"Zeus 040"                ,MSG_EXP_TURBOSCSIHD
		board     187,"A500 68040"              ,MSG_EXP_TURBO
		board     254,"Pixel64"                 ,MSG_EXP_GFX    ;boards
		board     255,"Pixel64"                 ,MSG_EXP_GFXRAM ;boards
		endmf   02026
		...
		manuf   02030,"Palomax"
		board     000,"MAX-125"                 ,MSG_EXP_MISC   ;boards         ;AUTOBOOT
		endmf   02030
		...
		board     003,"ALF 3"                   ,MSG_EXP_SCSIHD
		board     005,"Oktagon 2008"            ,MSG_EXP_SCSIHD ;boards
		board     006,"Tandem"                  ,MSG_EXP_SCSIHD ;boards
		board     008,"Memory-Master"           ,MSG_EXP_RAM    ;boards
		endmf   02049
		...
		board     001,"Malibu"                  ,MSG_EXP_SCSIHD ;boards
		endmf   02065
		...
		board     035,"Trifecta"                ,MSG_EXP_HD     ;boards
		board     255,"?"                       ,MSG_EXP_IDEHD  ;boards
		endmf   02071
		...
		board     024,"AlfaRAM"                 ,MSG_EXP_RAM    ;boards
		endmf   02076
		...
		boarda    002,"AlfaData","ALF 2"        ,MSG_EXP_SCSIHD ;boards
		boarda    003,"AlfaData","ALF 3"        ,MSG_EXP_SCSIHD ;boards
	       IFND     _NOFAKES
		...
		board     137,"Ariadne"                 ,MSG_EXP_ETHERNET ;boards
		endmf   02099
		...
		board     001,"FireCracker 24 PAL"      ,MSG_EXP_GFX    ;boards
		endmf   02104
		...
		board     242,"Vector"                  ,MSG_EXP_SCSIHD ;boards
		...
		board     002,"Symposium"               ,MSG_EXP_MISC   ;boards
		endmf   02114

		manuf   02116,"Pacific Digital"
		board     002,"PC-Access"               ,MSG_EXP_MISC   ;boards
		endmf   02116
		...
		board     001,"Access X"                ,MSG_EXP_HD     ;boards
		endmf   02126
		...
		board     002,"Vivid-24"                ,MSG_EXP_GFX    ;boards
		board     006,"Digital Broadcaster"     ,MSG_EXP_VIDEO
		board     009,"Digital Broadcaster"     ,MSG_EXP_VIDEO  ;boards
		endmf   02129
		...
		board     001,"Horizon"                 ,MSG_EXP_GFX    ;boards
		board     002,"BlackBox"                ,MSG_EXP_GFX    ;boards
		board     003,"Voyager"                 ,MSG_EXP_GFX    ;boards
		endmf   02154
		...
		board     002,"One Stop Music Shop"     ,MSG_EXP_AUDIO  ;boards
		endmf   02161
		...
		manuf   02191,"NewTek"
		board     000,"VideoToaster"            ,MSG_EXP_VIDEO  ;boards
		endmf   02191
		...
		board     000,"20bit / 4 channel"       ,MSG_EXP_AUDIO  ;boards
		board     001,"Digital Multitrack"      ,MSG_EXP_AUDIO  ;boards
		endmf   02202
		...
		manuf   02206,"Elbox"                   ; Michal Letowski, letowski@ci-1.ci.pwr.wroc.pl
		...
		board     019,"Turbo-Jet 1230xi"        ,MSG_EXP_TURBO  ;boards (latest)
		...
		manuf   04110,"DigiFeX"
		board     010,"Interact"                ,MSG_EXP_ETHERNET       ;boards
		endmf   04110

		manuf   04136,"Imtronics"       ;(Ronin)
		board     057,"Hurricane 2800 030/882"  ,MSG_EXP_TURBOANDRAM
		board     064,"Kronos II"               ,MSG_EXP_SCSIHD         ;boards
		board     087,"Hurricane 2800 030/882"  ,MSG_EXP_TURBOANDRAM
		endmf   04136

		manuf   04149,"ProTAR"
		board     051,"?"                       ,MSG_EXP_SCSIHD         ;boards
		board     052,"?"                       ,MSG_EXP_RAM            ;boards
		endmf   04149
		...
		board     003,"HyperCOM 3"              ,MSG_EXP_MULTIIO        ;boards
...
;                manuf   05768,"Bio-Con"                                         ;boards FAKE?
...
;                endmf   05768
		...
		manuf   08215,"Vortex"
		board     003,"Athlet"                  ,MSG_EXP_IDEHD          ;boards
		...
		board     068,"CyberVision PPC"         ,MSG_EXP_GFX    ;boards
		...
		board     001,"Frame Machine"           ,MSG_EXP_VIDEO  ;boards
		board     136,"ZIP"                     ,MSG_EXP_RAM    ;boards
		endmf   10676

		manuf   14501,"Petsoff LP"
		board     000,"Delfina DSP"             ,MSG_EXP_DSP
		board     001,"Delfina DSP Lite"        ,MSG_EXP_DSP    ;boards
		...
		manuf   17440,"HK Computer"                     ; Vector ??  17740(boards)
		board     000,"Vector"                  ,MSG_EXP_RAM
		...
		board     042,"RAM/ROM"                 ,MSG_EXP_MISC   ;boards
		endmf   19796

		manuf   22359,"Markt & Technik"
		board     137,"Videotext decoder"       ,MSG_EXP_MISC   ;boards
		endmf   22359

		manuf   26470,"Combitec"
		board     018,"?"                       ,MSG_EXP_RAM    ;boards  MID=26464 ?
		board     130,"?"                       ,MSG_EXP_RAM    ;boards
		endmf   26470
	...
	;ACHTUNG: es muß mindestens ein Manufacturer mit ID > 32767 existieren
		...
		board     033,"ST506 Autoboot"          ,MSG_EXP_MFMHD
		board     034,"SCSI Autoboot"           ,MSG_EXP_SCSIHD
		board     064,"DMX"                     ,MSG_EXP_MISC   ;boards
